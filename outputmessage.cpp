...
void OutputMessagePool::sendAll()
{
	...
	for(OutputMessageList::const_iterator it = m_addQueue.begin(), end = m_addQueue.end(); it != end; ++it)
	{
	...
	m_addQueue.clear();
	for(OutputMessageList::iterator it = m_autoSend.begin(), end = m_autoSend.end(); it != end; it = m_autoSend.erase(it))
	{
		OutputMessage_ptr omsg = (*it);
